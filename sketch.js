var bg,sleep,brush,drink,eat,gym,move,astronaut
function preload() {
...
function draw() {
  ...
  text("flecha hacia abajo=ejercitase",20,70)
  ...
  if(keyDown("DOWN_ARROW")){
    astronaut.addAnimation("gimnasio",gym);
    astronaut.changeAnimation("gimnasio")
    astronaut.y =350
    astronaut.velocityX=0
    astronaut.velocityY=0
    }
